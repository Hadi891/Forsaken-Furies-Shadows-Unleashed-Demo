window.addEventListener('load', function(){
    ...
    class Background{
        ...
        increaseSpeed(){
            const scoreMultiplier = Math.floor(score/3);
            this.speed = this.baseSpeed + scoreMultiplier * this.speedMultiplier;
        }
    }
    ...
    function displayStatusText(context){
        ...
        if(gameOver){
            ...
            context.textAlign = 'center';
            context.fillStyle = 'white';
            context.fillText('GAME OVER', canvas.width/2 + 3, 203);
            context.textAlign = 'center';
            context.fillStyle = 'black';
            ...
            context.fillStyle = 'white';
            context.fillText('Press Enter or swipe down to restart', canvas.width / 2 + 3, 253);
        }
    }
